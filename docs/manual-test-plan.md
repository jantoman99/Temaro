...
- Zkontrolovat root landing page `/`: aktuální veřejný směr je Fresha-like premium salon platform, tedy krátký claim `Plnější kalendář bez volání.`, velký code-native produktový desktop+telefon náhled, čistý bílý/porcelain canvas, bez tří malých překryvných hero fotek a s produktovým průchodem rezervace bez fake metrik, referencí a log. Přihlášená aplikace dál může držet Signal OS.
