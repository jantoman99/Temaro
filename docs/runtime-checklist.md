...
- Vercel production deploy 2026-06-09 00:12 CEST: `dpl_FgC7m2FppWuFF1yPezJZm8uMJkjr` je aliasovaný na `https://rezervacni-system-xi.vercel.app`. Produkční `/api/health` vrací `status=ok`, smoke proti produkci prošel 11/11 a homepage má nový business discovery hero bez horizontálního overflow.
