...
- Runtime po aktuálním hero salon wall redesignu ověřit na staging `/`: first fold musí obsahovat claim `Rezervace bez chaosu v inboxu.`, badge `Rezervace ze všech kanálů`, lokální hero image `/marketing/hero/salon-command-wall.webp`, `temaro-salon-hero`, `temaro-salon-wall`, `temaro-hero-photo`, `temaro-booking-stack`, kanálové pilly/karty `Instagram`, `Google`, `QR`, `Web`, CTA `Registrovat salon` a `Vidět ukázku`, desktop navigaci `Produkt / Pro koho / Návody / Ceník / Bez marketplace / Bezpečnost / Ukázka`, mobilní hamburger menu, sekce `pro-koho`, `produktovy-dukaz`, `cenik`, `bez-marketplace`, `jak-to-funguje`, `bezpecnost` a nulový horizontální overflow na desktopu i mobilu. Nesmí existovat `window.setInterval`, `temaro-hero-flow`, `temaro-arrival-card`, `temaro-orbit-card`, `temaro-live-thread`, `temaro-cinema-frame`, `temaro-screenshot-gallery`, `temaro-screenshot-strip`, `booking-phone-preview`, `/marketing/product/temaro-product-app-screen.jpg`, `/marketing/product/temaro-client-booking-mobile.jpg`, `/marketing/product/temaro-business-discovery.jpg`, `trust-bar`, `salon-operating-hero`, `product-window-*`, `photo-led-hero`, `dispatch-day-rail`, `mobile-day-rail` ani `dispatch-proof-strip`.
