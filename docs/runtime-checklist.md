...
- Runtime po aktuálním Time Atelier landing redesignu ověřit na staging `/`: hero text `Váš kalendář má mít vlastní rytmus.`, viditelný badge `Ateliér času Temaro`, class `temaro-time-atelier-hero`, produktové kino `temaro-cinema-frame`, screenshot galerii `temaro-screenshot-gallery`, časovou linku `temaro-time-thread`, reálné assety `/marketing/product/temaro-product-app-screen.jpg`, `/marketing/product/temaro-client-booking-mobile.jpg`, `/marketing/product/temaro-business-discovery.jpg`, CTA `Registrovat salon` a `Spustit ukázku`, desktop navigaci `Produkt / Pro koho / Návody / Ceník / Bez marketplace / Bezpečnost / Ukázka`, mobilní hamburger menu, sekce `pro-koho`, `produktovy-dukaz`, `cenik`, `bez-marketplace`, `jak-to-funguje`, `bezpecnost` a nulový horizontální overflow na desktopu i mobilu. Sekce `produktove-demo`, `scenare`, `trust-bar`, `salon-operating-hero`, `salon-command-frame`, `product-window-hero`, `product-window-frame`, `product-proof-gallery`, `photo-led-hero`, `salon-phone-card`, `salon-scenes-grid`, `operating-table-stage`, `dispatch-day-rail`, `mobile-day-rail` a `dispatch-proof-strip` už nemají existovat.
...
- Runtime po Time Atelier passu ověřit viewporty 1440, 1366, 768, 390 a 375px: žádný horizontální overflow; desktop má výrazný text vlevo a produktové kino s reálným app screenshotem vpravo, tablet ukazuje screenshot bez desktop phone overlay, mobil má produktový screenshot hned po CTA a screenshot galerie nesmí vytvářet horizontální scroll.
