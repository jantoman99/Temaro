...
- Produkční deploy po homepage motion vrstvě je `dpl_CT2NmmE7bpkjELQrb3BiC8NUPgV5` na aliasu `https://rezervacni-system-xi.vercel.app`; `/api/health` 2026-06-06 15:52 CEST vrací `status=ok` a produkční public smoke prošel 10/10.
