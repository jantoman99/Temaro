...
- Lokální reapply po upřesnění uživatele 2026-06-15 13:44 CEST: velký produktový hero je znovu aplikovaný přes revert commitu `8fe2ba1`. Před staging deployem ověřit landing guard, `npm run check`, `/api/health` a HTML signatury.
