...
- `npm run check` prošlo 2026-06-09 23:22 CEST po staging workflow: 599 Vitest testů, migrations check, type-check, lint a produkční build. Cílený `npm run test -- tests/vercel-staging-workflow.test.ts` prošel 2/2.
