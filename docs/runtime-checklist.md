...
- Vercel deploy alias: `https://rezervacni-system-xi.vercel.app`, aktuální production deploy `dpl_4E4V3JhDnfw3FmqGLHahaoUvnuEB`. Externí smoke 2026-06-01 12:39 CEST prošel: `PLAYWRIGHT_BASE_URL=https://rezervacni-system-xi.vercel.app npx playwright test tests/e2e/public-smoke.spec.ts` má 8/8 testů zelených.
