...
- `npm run check` prošlo 2026-05-31 21:47 CEST po přepojení marketing obrázků na vlastní WebP assety: 556 Vitest testů, migrations check, type-check, lint a produkční build.
