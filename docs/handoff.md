...
- Aktuální frontend/design směr: homepage drží koncept `Temaro Time Atelier` / `calendar-led control room`. Root landing používá claim `Váš kalendář má mít vlastní rytmus.`, class `temaro-time-atelier-hero`, code-native provozní kalendář `temaro-control-room`, `temaro-calendar-board`, `temaro-live-booking`, `temaro-live-thread`, animované slovo v H1 a proof čísla z demo dne. Hero neobsahuje screenshoty ani `next/image`.
...
- Aktuální landing pass 2026-06-14 nahrazuje screenshot-led Time Atelier pass v aktivním UI: hero je `temaro-time-atelier-hero`, používá `Ateliér času Temaro`, `Živý CRM kalendář`, `temaro-control-room`, `temaro-calendar-board`, `temaro-live-booking`, CTA `Registrovat salon` a `Spustit ukázku`. Navazující sekce jsou `#pro-koho`, `#produktovy-dukaz`, `#cenik`, `#bez-marketplace`, `#jak-to-funguje` a `#bezpecnost`. `temaro-cinema-frame`, `temaro-screenshot-gallery`, `temaro-screenshot-strip`, `temaro-time-thread`, `booking-phone-preview`, `/marketing/product/temaro-product-app-screen.jpg`, `/marketing/product/temaro-client-booking-mobile.jpg`, `/marketing/product/temaro-business-discovery.jpg`, `salon-operating-hero`, `product-window-*`, `photo-led-hero`, `dispatch-*`, before/after hero a `id="trust-bar"` se nesmí vrátit.
...
- Aktuální hero first-5 pass 2026-06-14 16:01 CEST: homepage hero používá kratší claim `Nová rezervace. Klidný den.` a živý product-led flow podle 2026 SaaS patternů. `BusinessDiscoveryHero` obsahuje `HeroSignalFlow`, `heroFlowSteps`, `temaro-hero-flow`, `temaro-arrival-card`, `temaro-orbit-card` a code-native control room; starý `AnimatedWord`/`temaro-word-swap` byl odstraněný. First-fold audit je v `output/playwright/hero-first5-2026-06-14/`; desktop i mobil mají `overflowX=0` a vidí produktový/flow důkaz v prvním viewportu.
