...
- Aktuální frontend/design směr: homepage hero drží koncept `Salon Booking Control Wall`. Root landing používá claim `Rezervace bez chaosu v inboxu.`, class `temaro-salon-hero`, lokální salon image `public/marketing/hero/salon-command-wall.webp`, code-native booking stack `temaro-booking-stack` a kanálové prvky Instagram/Google/QR/Web. Hero neobsahuje product screenshoty, orbit/scan motion ani intervalovou animaci.
