...
- Poslední lokální ověření 2026-06-10 20:30 CEST po `TEMARO_UPDATE_2`: `npm run check` prošlo s 603 Vitest testy, migrations check, type-check, lint a produkční build. Cílený landing guard prošel 25/25.
