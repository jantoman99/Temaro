...
- Poslední staging ověření 2026-06-11 15:39 CEST po photo-led passu: commit `e58e337` je na `origin/dev`, preview deploy `dpl_62Zw1AQqgNc7yP62BERA7ACycX3Z` je aliasovaný na `https://rezervacni-system-dev.vercel.app`. Ověřeno: `/api/health=ok`, HTML obsahuje `Méně zvonění`, `Plnější kalendář`, `photo-led-hero`, `salon-day-hero`, `salon-phone-card`, `salon-proof-strip`; není přítomné `operating-table-stage`, `Provozní stůl dne`, `hero-before-after-stage`, `Den před Temarem`, `Den s Temarem`, `dispatch-day-rail`, `mobile-day-rail`, `dispatch-proof-strip` ani `id="trust-bar"`.
