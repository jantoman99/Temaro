...
- Poslední staging před product-window deployem byl photo-led commit `e58e337`, preview `dpl_62Zw1AQqgNc7yP62BERA7ACycX3Z`, alias `https://rezervacni-system-dev.vercel.app`. Nový deploy musí ověřit `/api/health=ok` a HTML signatury `Rezervace, které vidíte hned v kalendáři`, `product-window-hero`, `product-window-frame`, `booking-phone-preview`, `product-proof-gallery`, `product-proof-board`; nesmí být přítomné `photo-led-hero`, `salon-phone-card`, `/marketing/salon-day-hero.webp`, `Den před Temarem`, `Den s Temarem`, `dispatch-day-rail`, `mobile-day-rail`, `dispatch-proof-strip` ani `id="trust-bar"`.
