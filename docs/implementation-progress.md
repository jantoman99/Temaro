...
- Lokální ověření 2026-06-10 20:20 CEST po `TEMARO_UPDATE_2`: `npm run check` prošlo s 603 Vitest testy, migrations check, type-check, lint a produkční build. Cílený guard `npm run test -- tests/landing-polish.test.ts` prošel 25/25.
