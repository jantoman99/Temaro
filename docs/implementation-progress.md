...
- Produkční deploy 2026-06-09 00:12 CEST: ruční Vercel deploy `dpl_FgC7m2FppWuFF1yPezJZm8uMJkjr` je aliasovaný na `https://rezervacni-system-xi.vercel.app`. Produkční `/api/health` je `ok`, homepage obsahuje nový hero text a produkční public smoke prošel 11/11.
