...
Aktualizováno: 2026-06-14 17:05 CEST
...
- Aktivní landing hero směr od 2026-06-14 17:05 CEST je `Salon Booking Control Wall`: first fold používá claim `Rezervace bez chaosu v inboxu.`, class `temaro-salon-hero`, lokální salon image `public/marketing/hero/salon-command-wall.webp`, code-native booking stack `temaro-booking-stack` a kanálové prvky `Instagram`, `Google`, `QR`, `Web`. Hero už nepoužívá `temaro-hero-flow`, `temaro-arrival-card`, `temaro-orbit-card`, `temaro-live-thread`, intervaly ani product screenshot assety z `public/marketing/product/`.
