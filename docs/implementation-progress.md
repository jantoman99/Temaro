...
- Poslední staging před product-window deployem byl photo-led pass `e58e337` / `dpl_62Zw1AQqgNc7yP62BERA7ACycX3Z`. Po commitu product-window směru musí staging HTML obsahovat `product-window-hero`, `product-window-frame`, `booking-phone-preview`, `product-proof-gallery`, `product-proof-board` a nesmí obsahovat `photo-led-hero`, `salon-phone-card`, `/marketing/salon-day-hero.webp`, before/after ani dispatch signatury.
