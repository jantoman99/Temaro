...
- Aktivní landing směr od 2026-06-11 23:59 CEST je `Temaro Time Atelier` / `Ateliér času Temaro`: first fold používá výrazný claim `Váš kalendář má mít vlastní rytmus.`, animované slovo `kalendář/provoz/rozvrh/den`, count-up proof čísla z demo dne, class `temaro-time-atelier-hero`, produktové kino `temaro-cinema-frame`, časovou linku `temaro-time-thread` a reálné screenshoty Temara místo dekorativních karet.
- Root homepage teď používá screenshot-led produktový důkaz: `public/marketing/product/temaro-product-app-screen.jpg`, `temaro-client-booking-mobile.jpg` a `temaro-business-discovery.jpg`. Neobsahuje `salon-operating-hero`, `salon-command-frame`, `product-window-hero`, `product-window-frame`, `product-proof-gallery`, lifestyle/AI salonové fotky, `photo-led-hero`, `salon-phone-card` ani salon-day obrázky. Aktivní zákaz zůstává nevracet `dispatch-day-rail`, `mobile-day-rail`, `dispatch-proof-strip`, `id="trust-bar"`, before/after hero ani photo-led root hero.
- Lokální screenshot audit po Time Atelier passu: `output/playwright/landing-personality-2026-06-11/pass5/home-1440.png`, `home-1366.png`, `home-768.png`, `home-390.png`, `home-375.png`. Browser audit potvrdil horizontální overflow `0` pro 1440, 1366, 768, 390 a 375px; `hasHero=true`, `hasCinema=true`, `hasGallery=true`, `hasOldSalonHero=false`, `hasOldProductWindow=false`, stránka renderuje 5 produktových obrázků a viditelné screenshoty jsou načtené.
