...
- Staging pro Time Atelier pass čeká na commit, push na `origin/dev`, Vercel preview deploy a ověření `/api/health` + HTML signatur. Poslední veřejný staging před tímto passem zůstává `dpl_8ozzwSbGcdG2XKRP9Ku3KJssKgFZ` se starším salon-operating obsahem.
