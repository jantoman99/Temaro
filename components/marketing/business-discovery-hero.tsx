...
const industryOptions = [
  {
    ...
    person: "Tereza",
    reservations: [
      { time: "09:30", title: "Barva kořínků", client: "Lenka S.", width: "42%", left: "8%" },
      { time: "12:00", title: "Střih + péče", client: "Jana K.", width: "36%", left: "38%" },
      { time: "16:30", title: "Melír", client: "Michaela P.", width: "31%", left: "66%" },
    ],
  },
  {
    label: "Barber",
    ...
    person: "Adam",
    reservations: [
      { time: "10:00", title: "Fade", client: "Tomáš M.", width: "26%", left: "12%" },
      { time: "13:30", title: "Střih vousů", client: "Petr D.", width: "28%", left: "44%" },
      { time: "17:00", title: "Komplet", client: "David R.", width: "24%", left: "72%" },
    ],
  },
  {
    label: "Kosmetika",
    ...
    person: "Nela",
    reservations: [
      { time: "08:30", title: "Hydratace pleti", client: "Eva H.", width: "34%", left: "4%" },
      { time: "11:30", title: "Brow styling", client: "Klára V.", width: "30%", left: "34%" },
      { time: "15:30", title: "Lash lift", client: "Anna T.", width: "34%", left: "62%" },
    ],
  },
  {
    label: "Trenér",
    ...
    person: "Filip",
    reservations: [
      { time: "07:00", title: "Silový trénink", client: "Martin L.", width: "28%", left: "2%" },
      { time: "12:30", title: "Konzultace", client: "Sára N.", width: "28%", left: "40%" },
      { time: "18:00", title: "Technika běhu", client: "Ondřej B.", width: "29%", left: "70%" },
    ],
  },
] as const;
  ...
  function reserveSelectedSlot() {
    setReservations((current) => {
      const nextReservation = {
        ...
        width: "28%",
        left: selectedSlot === "10:30" ? "18%" : selectedSlot === "11:00" ? "24%" : selectedSlot === "14:00" ? "50%" : selectedSlot === "15:30" ? "62%" : "76%",
      };
    ...
    <section id="produkt" className="business-discovery-hero temaro-time-hero relative overflow-hidden pt-24 sm:pt-28">
      ...
      <div className="mx-auto grid min-h-[790px] w-full max-w-[1280px] items-center gap-10 px-4 pb-16 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8 lg:pb-24">
        <div className="relative z-10 max-w-3xl">
          <p className="section-eyebrow">Rezervační systém, kde čas konečně drží tvar</p>
          <h1 className="font-display mt-5 text-balance text-6xl font-semibold leading-[0.9] text-[var(--ink)] sm:text-7xl lg:text-[6.8rem]">
          ...
          <p className="mt-8 max-w-2xl text-xl font-semibold leading-[1.45] text-[var(--ink-soft)] sm:text-2xl">
        ...
        >
          <div className="flex flex-col gap-4 rounded-[1.5rem] bg-[var(--ink)] p-4 text-white sm:p-5">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <p className="font-time text-xs uppercase tracking-[0.18em] text-white/56">Dnes · středa</p>
            ...
            <div className="temaro-day-grid relative h-[330px] overflow-hidden rounded-[1.25rem] border border-white/10 bg-white/[0.06] p-3">
              <div className="font-time flex justify-between text-[0.68rem] uppercase tracking-[0.12em] text-white/46">
              ...
              {reservations.map((reservation, index) => (
                ...
                >
                  ...
                  <p className="mt-1 text-xs font-semibold text-[var(--ink-faint)]">{reservation.client}</p>
                </article>
              ))}
            </div>
          </div>
          ...
          <div className="mt-4 rounded-[1.5rem] border border-[var(--paper-line)] bg-[var(--porcelain)] p-4">
            ...
            <button
              type="button"
              className="temaro-focus-ring mt-4 inline-flex h-12 w-full items-center justify-center gap-2 rounded-full bg-[var(--cobalt)] text-base font-bold text-white transition hover:bg-[var(--cobalt-deep)]"
              onClick={reserveSelectedSlot}
            >
              <Plus className="size-4" />
              Rezervovat {selectedSlot}
            </button>
          </div>
        </aside>
      </div>
