...
describe("landing polish guard", () => {
  ...
  test("homepage hero follows the Fresha-like premium salon platform direction", () => {
    ...
    expect(hero).toContain("temaro-black-hero-grid");
  ...
  test("new control room visual classes are declared and old active classes are gone", () => {
    ...
    expect(globals).toContain(".temaro-black-hero-grid");
    ...
    expect(globals).toContain("border: 0.52rem solid color-mix(in srgb, var(--ink) 92%, black)");
    ...
    expect(globals).toContain("linear-gradient(180deg, #ffffff 0%, #ffffff 56%, #f5f5f2 100%)");
    expect(globals).toContain(".temaro-premium-stage::before");
    expect(globals).toContain("linear-gradient(180deg, #111111 0%, #000000 100%)");
    ...
    expect(globals).toContain("min-height: 28rem");
    expect(globals).toContain("bottom: 0.75rem");
    expect(globals).toContain("right: 2rem");
    expect(globals).toContain("width: min(15.5rem, 22vw)");
