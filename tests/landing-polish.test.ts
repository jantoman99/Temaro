...
describe("landing polish guard", () => {
  ...
  test("homepage uses the Fresha-like premium salon platform architecture", () => {
    ...
    expect(page).toContain("bookingScenePanels");
    expect(page).toContain("temaro-booking-scene");
    expect(page).toContain("temaro-booking-scene-grid");
    expect(page).toContain("temaro-booking-scene-lead");
    expect(page).toContain("temaro-booking-scene-card");
    expect(page).toContain("temaro-booking-scene-overlay");
    expect(page).toContain("Fotky provozu musí vysvětlovat rezervace");
    expect(page.indexOf("<BusinessDiscoveryHero />")).toBeLessThan(page.indexOf("temaro-booking-scene"));
  ...
  test("homepage hero follows the Fresha-like premium salon platform direction", () => {
    ...
    expect(hero).not.toContain("bookingScenePanels");
    expect(hero).not.toContain("temaro-booking-scene");
  ...
  test("homepage follows DESIGN.md 5/5 product-object rhythm", () => {
    ...
    expect(page).toContain("temaro-booking-scene");
    expect(page).toContain("temaro-booking-scene-copy");
    expect(page).toContain("temaro-booking-scene-meta");
    expect(page).toContain("Vlastní rezervace · bez marketplace");
    expect(page).toContain("Fotky provozu musí vysvětlovat rezervace");
    expect(page).toContain("Salon na fotce. Rezervace v kontextu.");
    ...
    expect(globals).toContain(".temaro-booking-scene");
    expect(globals).toContain(".temaro-booking-scene-grid");
    expect(globals).toContain(".temaro-booking-scene-lead");
    expect(globals).toContain(".temaro-booking-scene-card");
    expect(globals).toContain(".temaro-booking-scene-overlay");
    expect(globals).toContain(".temaro-booking-scene-copy");
